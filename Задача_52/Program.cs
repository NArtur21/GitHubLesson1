...
{
    string result = "Среднее орефметическое каждого столбца: ";
    double sum;
    double average;
...
Console.Write("Введите количество строк в двумерный массив: ");
int rows = int.Parse(Console.ReadLine()!);

Console.Write("Введите количество столбццов в двумерный массив: ");
